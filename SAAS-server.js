...
<title>Menu QR Code — Créez le menu digital de votre commerce</title>
...
<body class="fond-braise">
  <main class="auth-page">
    <div class="auth-card" style="max-width:420px; text-align:center;">
      ...
      <h1 style="margin-bottom:8px;">Votre menu, sur un QR code</h1>
      <p style="opacity:0.85; margin-bottom:28px; line-height:1.5;">
        Créez votre catalogue en ligne en 2 minutes. Vos clients scannent, voient vos produits et vos prix — sans imprimer, sans réimprimer.
      </p>
      <a href="/signup" class="btn-primary" style="display:block; margin-bottom:14px;">Créer mon menu gratuitement</a>
      <a href="/login" class="lien-discret" style="display:block;">J'ai déjà un compte — Me connecter</a>
    </div>
  </main>
</body>
</html>`;
...
const serveur = http.createServer((req, res) => {
  ...
  if (chemin === '/signup' && req.method === 'POST') {
    ...
    req.on('end', () => {
      const { nom, motdepasse } = querystring.parse(corps);
